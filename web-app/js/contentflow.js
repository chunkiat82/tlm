    ...
    onloadInit: function () {
        ...
        for (var i=0; i< ContentFlowGlobal.loadAddOns.length; i++) {
            ...
            if (!ContentFlowGlobal.AddOns[a]) {
                ...
                window.setTimeout( CFG.onloadInit, 100);
                return;
            }
        }
...
ContentFlow.prototype = {
    ...
    _defaultConf: { 
        ...
        onMoveTo: function(item) { 
	        ...
	        //PublicationsPers.getPublicationSlider().setValue(i);
        },
...
*/
    ...
    moveTo: function (i) {
        ...
        else if (isNaN(i) || (i == Math.floor(i) && i < this.items.length) ) {
    ...
    _initGUI: function () {
        ...
        //this.globalCaption = this.Container.getElementsByClassName('globalCaption')[0];
        this.globalCaption = document.getElementById('globalCaption');
